...
Details <small>Laporan Masuk</small>
</h1>
<ol class="breadcrumb">
<li>
...
<a href="<?php echo $base;?>sedang_diproses/set/<?php echo $row->id;?>">
...
<p class="list-group-item" style="text-align:center;">
<button type="button" class="btn btn-green" id="ubah_status">Ubah Status Laporan Menjadi Telah Diproses</button>
</a>
</p>
<?php endif; ?>
...
<a href="<?php echo $base;?>laporan_masuk">Lihat Seluruh Laporan Masuk <i class="fa fa-arrow-circle-right"></i></a>
</div>
</div>
</div>
</div>
